...
export default class Pagination extends PureComponent {
    ...
    static propTypes = {
        ...
        containerStyle: View.propTypes?.style ? View.propTypes.style : () => null,
        dotColor: PropTypes.string,
        dotContainerStyle: View.propTypes?.style ? View.propTypes.style : () => null,
        dotElement: PropTypes.element,
        dotStyle: View.propTypes?.style ? View.propTypes.style : () => null,
        inactiveDotColor: PropTypes.string,
        inactiveDotElement: PropTypes.element,
        inactiveDotOpacity: PropTypes.number,
        inactiveDotScale: PropTypes.number,
        inactiveDotStyle: View.propTypes?.style ? View.propTypes.style : () => null,
